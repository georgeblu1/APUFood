...
public class AddFood extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        FoodDetails a = new FoodDetails(foodid,foodname,foodprice,foodquantity,fooddesc,foodtype);
        foodDetailsFacade.create(a);
        
        request.getRequestDispatcher("ViewFood").include(request, response);
