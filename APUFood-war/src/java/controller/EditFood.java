 ...
 * @author George
 */
@WebServlet(name = "EditFood", urlPatterns = {"/EditFood"})
public class EditFood extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        FoodDetails s = (FoodDetails) hs.getAttribute("user");
        
        try (PrintWriter out = response.getWriter()) {
            request.getRequestDispatcher("admin.jsp").include(request, response);
            out.println("<h2>Search to Edit/Delete</h2>");
            request.getRequestDispatcher("searchfood.jsp").include(request, response);
